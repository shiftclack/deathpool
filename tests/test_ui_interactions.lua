...
local function testRefreshMethods()
    ...
    assertTruthy(findTooltipLineIndex("Level 10-19, source Hogger, zone Elwynn Forest.") == nil, "recent death row tooltip should omit the prediction text in compact mode")
    ...
    assertTruthy(findTooltipLineIndex("Level 10-19, source Hogger, zone Elwynn Forest.") == nil, "collapsed death log name hover should omit the prediction text in compact mode")
    ...
    assertContains(DeathpoolDebug.detailValues.lockedPrediction:GetText(), "Level 20-29, source Hogger, zone Elwynn Forest", "debug window should show the latest locked prediction")
    ...
    assertEquals(GameTooltip.lines[6].left, "Level 10-19, source Hogger, zone Elwynn Forest.", "history log points hover should show the prediction text after the divider")
...
local function testRefreshMethodsPreferIntroDemoStateOverLiveDatabase()
    ...
    assertContains(
        Deathpool.lockedPredictionValue:GetText(),
        "Level 30-39, source Burning Blade Cultist, zone Desolace",
...
local function testDeathLogListTooltipOptionsCanSwitchContexts()
    ...
    assertTruthy(findTooltipLineIndex("Level 10-19, source Hogger, zone Elwynn Forest.") == nil, "main log tooltip options should omit prediction text in compact mode")
    ...
    assertTruthy(findTooltipLineIndex("Level 10-19, source Hogger, zone Elwynn Forest.") == nil, "collapsed log tooltip options should omit prediction text in compact mode")
