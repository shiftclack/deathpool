...
local function testIntroDemoRefreshUsesMainWindowOnlyState()
    ...
    assertEquals(Deathpool.levelRangeButtons[1]:IsEnabled(), false, "intro demo should disable the placeholder level button")
    assertEquals(Deathpool.levelRangeButtons[2]:IsEnabled(), false, "intro demo should disable the active prediction level button")
    assertEquals(Deathpool.levelRangeButtons[3]:IsEnabled(), false, "intro demo should disable inactive prediction level buttons")
